...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '可可HXL', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '可可HXL', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.kekehxl.com', // 网站地址
